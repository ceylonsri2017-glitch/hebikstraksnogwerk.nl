  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-slate-50 text-slate-900">
      ...
      <div className="flex justify-center w-full gap-4">
        ...
        <Link href="/risico-uitleg" className="text-sm text-slate-500 hover:text-orange-600 hover:underline mt-8 block">
          Meer weten over AI en werkrisico's? Lees de veelgestelde vragen.
        </Link>
